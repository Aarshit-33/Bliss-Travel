<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contect.aspx.cs" Inherits="contect" %>
   ...
   <div class="container-fluid page-header" style="background-image: url('all images/kerela123.png'); >
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 500px">
                ...
                <h3 class="display-4 text-white text-uppercase">Contect</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Contect</p>
                </div>
            </div>
        </div>
    </div>
                      ...
                      <form runat="server">
                            <div class="form-row">
                                <div class="control-group col-sm-6">
                                    ...
                                    <%--<asp:Label ID="name" runat="server" Text="Label" class="form-control p-4" placeholder="Your Name"--%>
                                        <%--required="required" data-validation-required-message="Please enter your name"></asp:Label>--%>
                            ...
                            <div class="control-group">
                                 <asp:TextBox ID="subject" runat="server" class="form-control p-4" placeholder="Your subject"></asp:TextBox>
                                <%--<input type="text" class="form-control p-4" id="subject" placeholder="Subject"
                                    required="required" data-validation-required-message="Please enter a subject" />--%>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                 <asp:TextBox ID="message" runat="server" class="form-control py-3 px-4" rows="5" placeholder="Your message"></asp:TextBox>
                            ...
                            <div class="text-center">
                                <asp:Button ID="Button1" runat="server" Text="send message"  class="btn btn-primary py-3 px-4" OnClick="Button1_Click"/>
