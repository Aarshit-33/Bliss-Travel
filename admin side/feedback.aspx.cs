...
public partial class admin_side_feedback : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            if (!IsPostBack)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("delete from feedback where id='" + Request.QueryString["d"] + "'", cn);
