...
<body class="login">
  <div class="container">
    <div class="login-container-wrapper clearfix">
      ...
      <form class="form-horizontal login-form" runat="server">
        ...
        <div class="form-group">
            <asp:Button ID="Button2" runat="server" class="btn btn-success btn-lg btn-block" Text="Submit" OnClick="Button2_Click1"  />
           </div>
