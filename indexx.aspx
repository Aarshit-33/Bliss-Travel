<%@ Page Language="C#" AutoEventWireup="true" CodeFile="indexx.aspx.cs" Inherits="indexx" %>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="all images/kerelaaaa1234.jpeg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="all images/kalen-emsley-Bkci_8qcdvQ-unsplash.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="all images/collage-transformed2.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <img class="img-fluid" src="all images/gangtok.jpg" alt="">
                            </div>
                        </div>
  ...
  <div class="container-fluid py-5">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="destination-item position-relative overflow-hidden mb-2">
                <img class="img-fluid" src="all images/eastindia.jpg" alt="">
                <a class="destination-overlay text-white text-decoration-none" href="Packagess.aspx">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="destination-item position-relative overflow-hidden mb-2">
                <img class="img-fluid" src="all images/udaypur2.jpg" alt="">
                <a class="destination-overlay text-white text-decoration-none" href="Packagess.aspx">
        ...
        <div class="col-lg-3 col-md-3  mb-4">
            <div class="destination-item position-relative overflow-hidden mb-2">
                <img class="img-fluid" src="all images/ravindra-sharma-Xpk0yx8pj5Y-unsplash.jpg" alt="">
                <a class="destination-overlay text-white text-decoration-none" href="Packagess.aspx">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="destination-item position-relative overflow-hidden mb-2">
                <img class="img-fluid" src="all images/chennai.jpg" alt="">
                <a class="destination-overlay text-white text-decoration-none" href="Packagess.aspx">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">A travel guide is a person who provides information and assistance to travelers..</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">
Ticket booking is process of reserving a seat or space for a particular event, activity,  transportation.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">Hotel booking is the process of reserving a room or accommodation at a hotel or similar establishment</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <h5 class="mb-2">Capture moment</h5>
                        <p class="m-0">Capturing a moment in data science typically involves extracting relevant information from a dataset to gain insights.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <h5 class="mb-2">Social meetups</h5>
                        <p class="m-0">Social meetups are events where people with similar interests gather to socialize, network, learn from each other</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-car mx-auto mb-4"></i>
                        <h5 class="mb-2">Active adventures</h5>
                        <p class="m-0">Active Adventures offers worldwide outdoor adventures, specializing in National Parks and family adventures.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ItemTemplate>
                    ...
                    <div class="package-item bg-white mb-2">
                     <%-- <img src= '<%#Eval("image")%>' width="350" height="250" alt="" />--%>
                         <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("image") %>' Height="250" Width="350" />
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i> </i><asp:Label ID="Label3" runat="server" Text='<%#Eval("person")%>'></asp:Label></small>
                            </div>
                            ...
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <h5 class="m-0"><asp:Label ID="Label5" runat="server" Text='<%#Eval("adprice")%>'></asp:Label>
                                    </h5>
                                   <%-- <h5><a href="packagess.aspx?id='<%#Eval("id")%>'">
